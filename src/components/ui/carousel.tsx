...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div ref={carouselRef} className="overflow-hidden grow">
      <div
        ref={ref}
        className={cn(
          "flex",
...
>((props, ref) => {
  ...
  if (numberOfSlides > 1) {
    return (
      <div ref={ref} className={cn('flex justify-center items-center', props.className)}>
        {Array.from({ length: numberOfSlides }, (_, i) => (
          <Button
            ...
            className={cn(  
              ...
              i === currentSlide
                ? 'scale-125 bg-gray-500 hover:bg-gray-500'
