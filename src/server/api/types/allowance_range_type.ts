...
// Exposed Types
// Create Types
export const createAllowanceRangeAPI = allowanceRangeBase.merge(dateCreate).omit({ end_date: true });
export const createAllowanceRangeService = allowanceRangeBase.merge(dateCreate);

// Update Types
export const updateAllowanceRangeAPI = allowanceRangeBase.merge(dateAll).partial().merge(Id);
export const updateAllowanceRangeService = allowanceRangeBase.merge(dateAll).partial().merge(Id);
