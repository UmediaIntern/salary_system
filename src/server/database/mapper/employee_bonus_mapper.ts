...
> {
	...
	async getEmployeeBonusFE(
		...
		const employeeBonusFE: EmployeeBonusFEType = {
			...
			currency_foreign: employee_bonus.currency_foreign,
			exchange_rate: employee_bonus.exchange_rate,
			currency_amount_foreign: employee_bonus.currency_amount_foreign,
			currency_amount_taiwan: employee_bonus.currency_amount_taiwan,
